...
<script src="<?php echo $URL;?>assets/plugins/alertify/alertify.min.js"></script>
<script src="<?php echo $URL;?>assets/plugins/alertify/custom-alertify.min.js"></script>
...
<script>
  // Llamamos a la función mostrarCarrito para cargar los datos
  mostrarCarrito();
  ...
  function mostrarCarrito() {
    ...
    // Actualizamos el número de productos en el carrito (modal y navegación)
    ...
    // Iteramos sobre los productos y los añadimos al carrito
              ...
              <div class="pr-2">
                ...
                <div class="d-flex align-items-center">
                  <input type="number" class="form-control form-control-sm bg-light mr-3" 
                         style="width: 4.5rem;" value="${producto.CANTIDAD_PRODUCTO}" readonly>
                         
                  <div class="text-nowrap"><strong class="text-danger">S/.${producto.PRECIO_OFERTA * producto.CANTIDAD_PRODUCTO}</strong></div>
                </div>
                <button class="btn btn-link btn-sm text-decoration-none px-0 pb-0" onclick="ELIMINAR_CARRITO(${index})">
                  Eliminar
                </button>
              </div>
            </div>
    ...
    let subtotal_carrito_modal = document.querySelector("#subtotal_carrito_modal");
    let subtotal_carrito_php = document.querySelector("#subtotal_carrito_php");
    let subtotal_carrito_aset = document.querySelector("#subtotal_carrito_aset");
    let total_pedido_carrito_php = document.querySelector("#total_pedido_carrito_php");

    subtotal_carrito_modal.textContent = "S/." + subtotalTotal;
    subtotal_carrito_php.textContent = "Subtotal: S/." + subtotalTotal;
    subtotal_carrito_aset.textContent = "S/." + subtotalTotal;
    total_pedido_carrito_php.textContent = "S/." + (subtotalTotal + 25);
