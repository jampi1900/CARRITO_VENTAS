      ...
      <div class="row flex-lg-nowrap">
        ...
        <div class="col">
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3" data-filters-columns>
            ...
            <?php
            while ($PRO = $DATOS_PRODUCTOS_T->fetch_assoc()) {

              $ID_PRODUCTO = $PRO['PK_Producto'];
            ?>
                ...
                <div class="card card-product mx-auto">
                  ...
                  <div class="card-body pb-2">
                    ...
                    ?>
                      ...
                      <div class="d-flex align-items-center">
                        <span class="h5 d-inline-block mb-0" style="text-decoration: line-through;">S/.<?php echo $PRO['Precio_Producto']; ?></span>
                      </div>
                      <div class="d-flex align-items-center">
                    ...
                    ?>
                      ...
                      <div class="d-flex align-items-center">
                        <span class="h5 d-inline-block mb-0">S/.<?php echo $PRO['Precio_Producto']; ?></span>
                      </div>
