    ...
    <section class="container pt-5 pt-lg-0">
      <div class="cs-carousel cs-nav-outside">
        <div class="cs-carousel-inner" data-carousel-options='{
          ...
          ?>
            <!-- Categoría -->
            <a href="producto.php" class="d-block cs-image-scale cs-heading-highlight text-center">
              <div class="cs-image-inner mb-2 rounded">
                <img src="../assets/img/ecommerce/home/categories/<?php echo $categorias['Foto_Categoria']; ?>" alt="<?php echo $categorias['Descripcion'] ?>">
              </div>
