...
include('../../app/controladores/Tallas/index.php');
include('../../app/controladores/Productos/get_datos.php');

$id_producto_color = $_GET['id'];

$SQL_TALLAS_TABLA = "SELECT * FROM tallas AS G INNER JOIN det_talla AS F ON F.FK_Talla = G.PK_Talla WHERE F.FK_Producto = '$id_producto_color'";
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo $URL;?>app/controladores/Productos/variedades.php" method="post" enctype="multipart/form-data">
                            <div class="row mb-4">
