        ...
        <li class="nav-item dropdown has-arrow main-drop">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <hr class="m-0">
                    <a class="dropdown-item logout pb-0" href="signin.html"><img src="<?php echo $URL; ?>assets/img/icons/log-out.svg" class="me-2" alt="img">Salir Seccion</a>
                </div>
            </div>
        </li>
    </ul>
            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo $URL; ?>src/Categorias/index.php">Lista Categorias</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    ...
                    <ul>
                        <li><a href="<?php echo $URL; ?>src/Pedidos/index.php">Lista Pedidos</a></li>
